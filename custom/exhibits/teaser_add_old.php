...
$query_item_js="select title from omeka_items where id=".$_POST['select_item']."";
				   ...
				   $query_teaser="insert into omeka_teasers (sec_id,exhibit_id,pg_id,item_id,type) values (".$sec_id.",".$exhibit_id.",".$pg_id.",".$_POST['select_item'].",'null')";
					...
					$result_teaser_id=mysql_fetch_array($result_teaser);
				        ?>
						  ...
						  window.close();
						  window.opener.document.getElementById('text_supporting').innerHTML += "<?php echo "<div style='padding-top:6px;'><a href='javascript:deleteObject(".$result_teaser_id['LAST_ID'].")' class='delete'><span class='section-delete'>&nbsp;</span></a><a style='padding-left:10px;' target='_new' href='http://education.natural-europe.eu/natural_europe/admin/items/show/".$_POST['select_item']."'>".$result_item_js['title']."</a></div>"; ?>";
						  </script>
...
echo "Select an object to add"; 
    ...
    echo '<select name="select_item" id="select_item">';
        ...
        $query_item="select id, title from omeka_items where (type_id='14' or type_id='18' or type_id='6' or type_id='11' or type_id='20') and public=1 order by title";
