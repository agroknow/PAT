...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php /*<link rel="stylesheet" media="screen" href="<?php echo $urllinkbase; ?>shared/exhibit_layouts/text-image-right/layout.css" /> */ ?>
        ...
        $autocomplete_scripts = "<script type='text/javascript' src='" . $AUTO_BASE . "lib/jquery.bgiframe.min.js'></script> " .
         ...
         $autocomplete_scripts.="<script type='text/javascript'> var user_id = ".$user_id."; </script>";
        $autocomplete_scripts.="<script type='text/javascript' src='" . $AUTO_BASE . "search_teaser.js?asd=123'></script> ";
        if (isset($_GET['testtime'])) {
            $autocomplete_scripts.="<script type='text/javascript' src='" . $AUTO_BASE . "search_testtime.js'></script> ";
        }
        if (isset($_GET['students_reality'])) {
            $autocomplete_scripts.="<script type='text/javascript' src='" . $AUTO_BASE . "search_students_reality.js'></script> ";
        }
        if (isset($_GET['evaluation_activities'])) {
            $autocomplete_scripts.="<script type='text/javascript' src='" . $AUTO_BASE . "search_evaluation_activities.js'></script> ";
        }
