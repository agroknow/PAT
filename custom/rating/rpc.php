...
$new_back[] .= '</ul><br>';
$new_back[] .= '<p class="voted"> Rating: <strong>'.@number_format($sum/$added,1).'</strong>/'.$units.' ('.$count.' '.$tense.' ) ';
$new_back[] .= '<span class="thanks">  You already rated this exhibit</span></p>';
