		...
		function JScrollPane(elem, s)
		{
			...
			function initialise(s)
			{
				...
				if (pane == undefined) {
					...
					pane = jQuery('<div class="jspPane" />').wrap(
						jQuery('<div class="jspContainer" />')
							.css({
								'width': paneWidth + 'px',
				...
				tempWrapper = jQuery('<div style="width:1px; position: relative;" />').append(clonedElem);
				...
				if (isScrollableV) {
					...
					verticalDrag.hover(
						...
						function(e)
						{
							...
							jQuery('html').bind('dragstart.jsp selectstart.jsp', function() { return false; });
