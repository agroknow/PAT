...
<object classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab" width="320" height="240">
				<param name="src" value="../../archive/movies/MOVIE5small.mp4" />
				<param name="controller" value="true" />
				<param name="autoplay" value="true" />
				<param name="loop" value="false" />
				<embed src="../../archive/movies/MOVIE5small.mp4" scale="tofit" width="320" height="240" controller="true" autoplay="true" pluginspage="http://www.apple.com/quicktime/download/" type="video/quicktime"></embed>
				</object>
</div><!-- end content -->
</div><!--end wrap-->
</body>
