<?php head(array('title'=>'Science Educators | Science communication reference material')); ?>
<div id="page-body" class="one_column">
<?php common('menu'); ?>
<div class="column science_educators" id="column-c">
<h1 class="section_title">Science communication reference material</h1>
...
require_once("./custom/general_content/func.php");
	...
	print_r (item_select("20","Science communication reference material")); 
