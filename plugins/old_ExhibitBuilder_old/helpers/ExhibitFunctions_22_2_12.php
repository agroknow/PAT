...
function exhibit_builder_user_can_edit($exhibit = null, $user = null)
{
    ...
    return (($exhibit->wasAddedBy($user) && $canEditSelf) || $canEditOthers || ($user['institution']==$exhibituser[0]['institution'] and $user['role']=='Museum Educators'));    
}
