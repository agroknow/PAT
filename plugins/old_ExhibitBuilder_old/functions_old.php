...
?>
	...
	<dt class="exhibits"><a href="<?php echo html_escape(uri('exhibits')); ?>">Pathways</a></dt>
	<dd class="exhibits">
		<ul>
			<li><a class="browse-exhibits" href="<?php echo html_escape(uri('exhibits')); ?>">Browse Pathways</a></li>
			<li><a class="add-exhibit" href="<?php echo html_escape(uri('exhibits/add/')); ?>">Create a Pathway</a></li>
		</ul>
		<p>Create and manage Pathways .</p>
	</dd>
	<?php endif;
}
...
{
    $navArray['Browse Pathways'] = uri('exhibits');
    return $navArray;
}
...
function exhibit_builder_admin_nav($navArray)
{
    if (has_permission('ExhibitBuilder_Exhibits', 'browse')) {
        $navArray += array('Pathways'=> uri('exhibits'));
    }
    return $navArray;
}
