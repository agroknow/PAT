...
function exhibit_builder_setup_acl($acl)
{
	...
	//Natural Europe code
	$acl->allow('Science center staff', 'ExhibitBuilder_Exhibits',array('add', 'editSelf', 'deleteSelf',
        'showNotPublic', 'add-page', 'edit-page-content',
        'edit-page-metadata', 'delete-page', 'add-section',
...
?>
	...
	<dt class="exhibits"><a href="<?php echo html_escape(uri('exhibits')); ?>"><?php echo __('Pathways'); ?></a></dt>
	<dd class="exhibits">
		<ul>
			<li><a class="browse-exhibits" href="<?php echo html_escape(uri('exhibits')); ?>"><?php echo __('Browse Pathways'); ?></a></li>
			<li><a class="add-exhibit" href="<?php echo html_escape(uri('exhibits/add')); ?>"><?php echo __('Create a Pathway'); ?></a></li>
		</ul>
		<p><?php echo __('Create and manage Pathways'); ?></p>
	</dd>
	<?php endif;
}
...
{
    $navArray[__('Browse Pathways')] = uri('exhibits');
    return $navArray;
}
...
function exhibit_builder_admin_nav($navArray)
{
    if (has_permission('ExhibitBuilder_Exhibits', 'browse')) {
        $navArray += array(__('Pathways') => uri('exhibits'));
    }
    return $navArray;
}
...
function exhibit_builder_append_to_advanced_search()
{
    $html = '<div class="field">'
          . __v()->formLabel('exhibit', __('Search by Pathway'))
          . '<div class="inputs">'
