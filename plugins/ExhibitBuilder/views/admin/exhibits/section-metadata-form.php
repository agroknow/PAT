...
<form method="post" accept-charset="utf-8" action="" id="section-metadata-form" class="exhibit-builder">
	...
	<fieldset>
	    ...
	    <div class="field"><?php echo text(array('name'=>'title', 'id'=>'title', 'class'=>'textinput','readonly'=>'readonly'), $exhibitSection->title, __('Title')); ?></div>
        <div class="field">
            <?php echo text(array('name'=>'slug','id'=>'slug','class'=>'textinput','readonly'=>'readonly'), $exhibitSection->slug, __('Slug')); ?>
