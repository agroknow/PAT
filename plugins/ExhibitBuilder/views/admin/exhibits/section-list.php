    ...
    <?php foreach($exhibit->Sections as $key => $exhibitSection ): ?>
    	<li id="section_<?php echo html_escape($exhibitSection->id); ?>" class="exhibit-section-item">
    		<div class="section-info">
        		    ...
        		    <?php $sectiontitle=html_escape(snippet($exhibitSection->title, 0, 40, '')); ?>
                            <h3 class="section-title"><?php echo __($sectiontitle); ?></h3>
        		    <?php echo $exhibitSection->description; ?>
        		    <div class="section-actions">
        		       <?php /* <span class="section-edit"><a href="<?php echo html_escape(uri('exhibits/edit-section/'.$exhibitSection->id)); ?>" class="edit"><?php echo __('Edit Section'); ?></a></span>
			...
			<div class="section-actions">
			 <?php /*<span class="page-add"><a class="add" href="<?php echo html_escape(uri('exhibits/add-page/'.$exhibitSection->id)); ?>"><?php echo __('Add a Page'); ?></a></span>*/ ?>
			</div>
        	</div>
    	</li>
    <?php endforeach; ?>    
