...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <!--[if (gte IE 6)&(lte IE 8)]>
                <script type="<?php echo uri('plugins/ExhibitBuilder/views/public/exhibits/'); ?>text/javascript" src="javascript/selectivizr-min.js"></script>
        <![endif]-->
                ...
                $(function() {
                    ...
                    function setLightBox(file,size) {
                        ...
                        if(file.metadata.lom.general.keyword!=undefined) {
                            ...
                            imgInText.lb += '<span><b>'+file.metadata.lom.general.keyword.label+':</b> ';
                            if (file.metadata.lom.general.keyword instanceof Array) {
                                ...
                                imgInText.lb += tmpKeywords.join(', ');
                            } else {
                                imgInText.lb += file.metadata.lom.general.keyword.value;
                            }
                            imgInText.lb += '</span>';
                        ...
                        if (file.metadata.lom.metaMetadata!=undefined && file.metadata.lom.metaMetadata.contribute!=undefined) {
                            ...
                            if (file.metadata.lom.metaMetadata.contribute.role.id=="creator") {
                                ...
                                if (vcardFn!=undefined) vcardBlock += '<span class="fn"><b data-translation="Full_Name">Full Name:</b> '+vcardFn+'</span>';
                                if (vcardEmail!=undefined) vcardBlock += '<span class="email"><b data-translation="Email">Email:</b> '+vcardEmail+'</span>';
                                if (vcardOrg!=undefined) vcardBlock += '<span class="org"><b data-translation="Organization">Organization:</b> '+vcardOrg+'</span>';
                                vcardBlock += '</section>';
                        ...
                        $.ajax({
                            ...
                            success: function(j){
                                    ...
                                    $.each( tabs, function(k,v) {
                                        ...
                                        if (v.item  instanceof Array) {
                                            $.each( v.item, function(ks,vs) {
                                                section += setSectionContent(vs, resArray);
												
                                            });
                                        } else {
                                            section += setSectionContent(v.item, resArray);
                                        }
                                ...
                                if(j.metadata.omeka.dateModified!=undefined) {
                                    bi += '<div><label>Time last saved pathway:</label><span>'+j.metadata.omeka.dateModified+'</span></div>';
                                }
                                if(j.metadata.lom.metaMetadata.contribute.role!=undefined && j.metadata.lom.metaMetadata.contribute.role.value=='creator') {
                                    ...
                                    bi += '<div><label>Full Name:</label><span>'+vcFn+'</span></div>';
                                    bi += '<div><label>Email:</label><span>'+vcEmail+'</span></div>';
                                }
                                            ...
                                            $.each( j.metadata.lom.lifeCycle.contribute, function(lk,lv) {
                                                ...
                                                if (lv.role!=undefined) {
                                                    ...
                                                    if (lv.entity!=undefined) {
                                                        ...
                                                        lcText += '<div><span class="fn" data-translation="Full_Name">Full Name:</span>'+vcFn+'</div><div><span class="email" data-translation="Email">Email:</span>'+vcEmail+'</div><div><span class="org" data-translation="Organization">Organization:</span>'+vcOrg+'</div>';
                                        ...
                                        if (j.metadata.lom.metaMetadata.contribute instanceof Array) {
                                            ...
                                            $.each( j.metadata.lom.metaMetadata.contribute, function(lk,lv) {
                                                ...
                                                if (lv.entity!=undefined) {
                                                    ...
                                                    var vcEmail = vCard.initialize(vc).get_email();
                                                    var vcOrg = vCard.initialize(vc).get_org();
                                                    mmText += '<div><span class="fn" data-translation="Full_Name">Full Name:</span>'+vcFn+'</div><div><span class="email" data-translation="Email">Email:</span>'+vcEmail+'</div><div><span class="org" data-translation="Organization">Organization:</span>'+vcOrg+'</div>';
