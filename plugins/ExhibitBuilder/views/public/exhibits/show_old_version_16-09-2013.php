...
<h2 style="color:#90A886; font-size:13px;">

                <a href="javascript:toggleDiv('metadata_text');" ><?php echo __('Given Metadata'); ?>: </a></h2> 
<?php
echo "<strong>".__('Creator')." : </strong>".return_user_of_exhibit2($exhibit->id)."<br>";
echo '<div id="metadata_text" style="display:block;">';
