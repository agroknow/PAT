        ...
        <section class="inner info clearfix">
            ...
            <section class="moreinfo fr clearfix">
                ...
                <section class="fl clearfix social">
                    ...
                    <a target="_blank" href="<?php echo uri('exhibits/pdfexport?slug='.$exhibit->slug.'&lang='.$_SESSION['get_language'].'');?>" class="print" data-translation="Print">Print it!</a>
...
<!--<span class="time">53'</span>-->
        ...
        <script>
                ...
                ;
                (function($) {
                    $.exist || ($.extend({exist: function(a) {
                            if (null == typeof a || void 0 == a)
                                return!1;
                            var b = !1;
                            Array.prototype.slice.call(arguments, 1);
                            if ("object" == typeof a)
                                if (a instanceof jQuery)
                                    a.length && $.contains(document.documentElement, a[0]) && (b = !0), $.trim(a.selector).length && ($(a.selector).length && $.contains(document.documentElement, $(a)[0]) && (b = !0), "#" != a.selector.charAt(0) && "." != a.selector.charAt(0) && ($("#" + a.selector).length ? $.contains(document.documentElement, $("#" + a.selector)[0]) && (b = !0) : $("." + a.selector).length && $.contains(document.documentElement, $("." + a.selector)[0]) && (b = !0)));
                                else {
                                    if ($(a).length && $.contains(document.documentElement, a))
                                        return!0
                                }
                            else
                                "string" == typeof a && $.trim(a).length && ($(a).length && $.contains(document.documentElement, $(a)[0]) && (b = !0), "#" != a.charAt(0) && "." != a.charAt(0) && ($("#" + a).length ? $.contains(document.documentElement, $("#" + a)[0]) && (b = !0) : $("." + a).length && $.contains(document.documentElement, $("." + a)[0]) && (b = !0)));
                            b || console.log("Not Exist:\r\n\t", a);
                            return b
                        ...
                        function setLightBox(file, size) {
                            ...
                            if (file.metadata.lom.metaMetadata != undefined && file.metadata.lom.metaMetadata.contribute != undefined) {
                                ...
                                if (file.metadata.lom.metaMetadata.contribute.role.id == "creator") {
                                    ...
                                    if (vcardFn != undefined)
                                        vcardBlock += '<span class="fn"><b data-translation="Name">Name</b><b>:</b> ' + vcardFn + '</span>';
                                    if (vcardEmail != undefined)
                                        vcardBlock += '<span class="email"><b data-translation="Email">Email</b><b>:</b> ' + vcardEmail + '</span>';
                                    if (vcardOrg != undefined)
                                        vcardBlock += '<span class="org"><b data-translation="Organization">Organization</b><b>:</b> ' + vcardOrg + '</span>';
                                    vcardBlock += '</section>';
