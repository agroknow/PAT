...
<h1><?php echo $pageTitle;; ?></h1>
    <div id="primary">
       ...
       <?php /*?><?php if (has_permission('Upgrade', 'index')):
        ...
        <?php echo flash(); ?>    
            <div id="getting-started">
                ...
                <dl>
                    ...
                    <dd class="items">
                        <ul>
                            <?php /*<li><a class="add" href="<?php echo html_escape(uri('items/add')); ?>"><?php echo __('Add a new item to your archive'); ?></a></li>
                            <li><a class="add" href="<?php echo html_escape(uri('items/addlink')); ?>"><?php echo __('Add a new hyperlink to your archive'); ?></a></li>*/ ?>
                ...
                <?php /*?><?php if(has_permission('Collections','browse')): ?>
               ...
               <?php /*?> <?php if(has_permission('Users','browse')): ?>
              ...
              <?php /*?>  <?php if(has_permission('Settings', 'edit')): ?>
        ...
        <div id="secondary">
            <div id="site-meta" class="info-panel">
                 ...
                 * total_users()
                 */
                echo __('<em>%1$s</em> contains %2$s resources. There are %5$s users.', settings('site_title'), total_items(), total_collections(), total_tags(), total_users()); ?></p>
            </div>
            <div id="site-meta" class="info-panel">
			...
			<p><a href="http://wiki.agroknow.gr/agroknow/images/7/74/Natural_Europe_Educational_Pathway_Handbook_v4.pdf" target="_blank"><?php echo __('Natural Europe Handbook'); ?></a></p>
           ...
           <?php /*?> <div id="recent-items" class="info-panel">
            ...
            <?php /*?><div id="tag-cloud" class="info-panel">
