...
//echo 'http://collections.natural-europe.eu:8081/cmss/search?query='.$bytypeforurl.'text:'.$europeanatext.'&start='.$startPageurl.'';
...
<div style="float:left; width:670px; margin-left:25px;margin-top:20px;">
  ...
  $cb+=1;
   ...
   echo "<a href='". $source."' target='_new'>".__('Access to the resource')."</a><br>";
