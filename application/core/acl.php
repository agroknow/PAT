...
$allowList = array(
	...
	array('Science center staff', 'Items', array('tag', 'add', 'batch-edit', 'editSelf', 'deleteSelf', 'showSelfNotPublic','makePublic')),
    array('Science center staff', 'Users', array('browse', 'editSelf', 'deleteSelf')),
    array('Museum Educators', 'Items', array('tag', 'add', 'batch-edit', 'editSelf', 'deleteSelf', 'showSelfNotPublic','makePublic')),
    array('Museum Educators', 'Users', array('editSelf', 'deleteSelf')),
	array('Teachers-Students', 'Items', array('tag', 'add', 'batch-edit', 'editSelf', 'deleteSelf', 'showSelfNotPublic','makePublic')),
    array('Teachers-Students', 'Users', array('editSelf', 'deleteSelf')),
...
// New roles added for science tweets
$acl->addRole(new Zend_Acl_Role('Teachers-Students'));
