	...
	<input type='hidden' id='show_per_page' />		
		...
		//check the target group of the exhibit
		 ...
		 $o+=1;
			...
			<?php $target=target(); ?>
            	<li>
                	<a href="<?php echo uri('exhibits/show/'.$exhibits2['slug'].'/to-begin-with'.$target); ?>" class="block"></a>
                    <?php echo  exhibit_picture($exhibits2['id'],'135','indexstund'); ?>
                    <div class="exhibit-data">
                    	<p><?php echo $exhibits2['title']; ?></p>
                    </div>
                    <a href="<?php echo uri('exhibits/show/'.$exhibits2['slug'].'/to-begin-with'.$target); ?>" class="more"><?php echo __('GO NOW!'); ?></a>
                </li>
